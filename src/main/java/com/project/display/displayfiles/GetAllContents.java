 ...
 */
public class GetAllContents implements DisplayContent{
	/** Implemented Logger here **/
	private final static Logger LOG = Logger.getLogger(GetAllContents.class);
	private static List<String> finalList;
	
	public List<String> displayContent(final File dir) {
		finalList = new ArrayList<String>();
        GetAllContents.iterateContents(dir);		
		return finalList;
	}
